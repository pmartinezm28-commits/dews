...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
     ...
     <base href="https://www.php.net/manual/es/language.types.php">
  
  <title>PHP: Los tipos - Manual</title>
...
<div id="layout" class="clearfix">
      ...
      <form action="/manual/change.php" method="get" id="changelang" name="changelang">
        <fieldset>
          ...
          <select onchange="document.changelang.submit()" name="page" id="changelang-langs">
            <option value='en/language.types.php'>English</option>
            <option value='de/language.types.php'>German</option>
            <option value='es/language.types.php' selected="selected">Spanish</option>
 ...
 <h1 class="title">Los tipos</h1>
<h2>Tabla de contenidos</h2><ul class="chunklist chunklist_chapter"><li><a href="language.types.intro.php">Introducci&oacute;n</a></li><li><a href="language.types.type-system.php">Sistema de tipos</a></li><li><a href="language.types.null.php">NULL</a></li><li><a href="language.types.boolean.php">Booleano</a></li><li><a href="language.types.integer.php">Los enteros</a></li><li><a href="language.types.float.php">N&uacute;meros de punto flotante</a></li><li><a href="language.types.string.php">Cadenas</a></li><li><a href="language.types.numeric-strings.php">Strings num&eacute;ricos</a></li><li><a href="language.types.array.php">Arrays</a></li><li><a href="language.types.object.php">Los objetos</a></li><li><a href="language.types.enumerations.php">Las enumeraciones</a></li><li><a href="language.types.resource.php">Recursos</a></li><li><a href="language.types.callable.php">Funciones de retrollamada / Tipos Callable</a></li><li><a href="language.types.mixed.php">Mixed</a></li><li><a href="language.types.void.php">Void</a></li><li><a href="language.types.never.php">Never</a></li><li><a href="language.types.relative-class-types.php">Tipos de clases relativas</a></li><li><a href="language.types.singleton.php">Tipo singleton</a></li><li><a href="language.types.iterable.php">It&eacute;rables</a></li><li><a href="language.types.declarations.php">Declaraciones de tipo</a></li><li><a href="language.types.type-juggling.php">Manipulaci&oacute;n de tipos</a></li></ul>
    ...
    <div class="contribute">
      ...
      <div class="edit-bug">
        ...
        •
        <a href="https://github.com/php/doc-es/blob/master/language/types.xml">Submit a Pull Request</a>
        •
        <a href="https://github.com/php/doc-es/issues/new?body=From%20manual%20page:%20https:%2F%2Fphp.net%2Flanguage.types%0A%0A---">Report a Bug</a>
      </div>
    </div><section id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types&amp;repo=es&amp;redirect=https://www.php.net/manual/es/language.types.php">＋<small>add a note</small></a></span>
